...
import { getDoc, doc, addDoc, collection, getDocs, query, where, deleteDoc } from 'firebase/firestore';
			...
			<ScrollView contentContainerStyle={styles.scrollableContent}>
				<View style={styles.imageContainer}>
					{item && item.img ? (
						...
						<Image
							...
							style={[styles.image, { width: deviceWidth, height: (deviceWidth * 2) / 3 }]}
						/>
					)}
				</View>
				<View style={styles.productContentContainer}>
					<View style={styles.insideContentContainer}>
						...
						<Text style={styles.categoriesText}>Categories: {item.category}</Text>
